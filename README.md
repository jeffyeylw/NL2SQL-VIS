I have finetuned a LLM based on codellama-7b-instruct on text2sql task. I have also develop part of the frontend and a backend to automatically select chart type to visualize the SQL result 
System Overview
